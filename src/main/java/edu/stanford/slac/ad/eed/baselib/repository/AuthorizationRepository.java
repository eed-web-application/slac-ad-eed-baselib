...
public interface AuthorizationRepository extends CrudRepository<Authorization, String> {
    ...
    List<Authorization> findByOwnerAndOwnerTypeAndAuthorizationTypeIsGreaterThanEqualAndResourceStartingWith(String owner, edu.stanford.slac.ad.eed.baselib.model.Authorization.OType ownerType, Integer authorizationType, String resource);
